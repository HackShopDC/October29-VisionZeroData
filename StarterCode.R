library(rgdal)
library(plyr)
setwd ("/Users/katerabinowitz/Documents/HackShopDC/October29-VisionZeroData")

### Read in Data ###
### Read in Data ###
### Read in Data ###
# If you haven't read a GeoJson into R then see if 
...
VisZeroDF<-read.csv('Vision_Zero_Safety_Transportation.csv',na.strings=c("", "NA"),strip.white=TRUE,
